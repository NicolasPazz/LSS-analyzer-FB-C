...
// FUNCIONES
NodoFuncion* crearNodoFuncion(Parametro **listaDeParametros, const char *retorno, const char *funcion, const int linea, const char* tipogramatica){
...
//        Parametro *listaDeArgumentos = (Parametro *)elemento->listaDeParametros;
//        char mensaje[256];
//        snprintf(mensaje, sizeof(mensaje), " Lista de argumentos %s, %s", listaDeArgumentos->tipo, listaDeArgumentos->identificador);
//        agregarErrorSemantico(listaErroresSemanticos, mensaje, linea, columna);
//    }
}

Parametro* agregarParametroNuevo(char *tipo, char *identificador){
