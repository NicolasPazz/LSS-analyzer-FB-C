...
declaracion:
    ...
    | sufijo TIPODEDATO lista_declaradores_funcion ';'    { agregarFuncion(&listaFunciones, &tablaSimbolos, $2, nodoGenericoFuncion, yylloc.last_line, "declaracion", @1.first_column); DBG_PRINT("declaracion de funcion 1 %s %s %s\n", $1, $2, $3);}
    | sufijo VOID lista_declaradores_funcion ';'          { agregarFuncion(&listaFunciones, &tablaSimbolos, $2, nodoGenericoFuncion, yylloc.last_line, "declaracion", @1.first_column); DBG_PRINT("declaracion de funcion 2 %s %s %s\n", $1, $2, $3);}
    | TIPODEDATO lista_declaradores_funcion ';'           { agregarFuncion(&listaFunciones, &tablaSimbolos, $1, nodoGenericoFuncion, yylloc.last_line, "declaracion", @1.first_column); DBG_PRINT("declaracion de funcion 3 %s %s\n", $1, $2); }
    | VOID lista_declaradores_funcion ';'                 { agregarFuncion(&listaFunciones, &tablaSimbolos, $1, nodoGenericoFuncion, yylloc.last_line, "declaracion", @1.first_column); DBG_PRINT("declaracion de funcion 4 %s %s\n", $1, $2);}
    ;
...
argumento_prototipo
    ...
    | TIPODEDATO IDENTIFICADOR                      { agregarParametroNuevo($1,$2); parametro = unirParametros($1,$2); $$ = copiarCadena(parametro); agregarParametro(&listaParametros, parametro); DBG_PRINT("argumento_prototipo_final_3 %s\n", parametro); }
    ...
    | sufijo TIPODEDATO IDENTIFICADOR               { agregarParametroNuevo($2,$3); parametro = unirParametros($2,$3); agregarParametro(&listaParametros, parametro); DBG_PRINT("argumento_prototipo_final %s\n", parametro); }
...
definicion_funcion: 
      TIPODEDATO declarador_funcion sentencia_compuesta   { agregarFuncion(&listaFunciones, &tablaSimbolos, $1, nodoGenericoFuncion, yylloc.last_line, "declaracion", @1.first_column); DBG_PRINT("definiciones_externas: definicion de funcion\n"); }
    | VOID declarador_funcion sentencia_compuesta         { agregarFuncion(&listaFunciones, &tablaSimbolos, $1, nodoGenericoFuncion, yylloc.last_line, "declaracion", @1.first_column); DBG_PRINT("definiciones_externas: definicion de funcion VOID\n"); }
    ; 
%%
