...
definicion_funcion: 
    ...
    ; 
definidor_funcion:
    IDENTIFICADOR '(' lista_argumentos_definicion ')' //{ agregarFuncion(&listaFunciones, $1, $3, yylloc.last_line, "definicion", NULL); DBG_PRINT("definidor_funcion\n"); }
    ;
